...
import 'package:flutter_finance_app/services/supabase_service_settlement.dart';
import 'package:flutter_finance_app/utils/cache_manager.dart';

class FixedSettlementProvider with ChangeNotifier {
  ...
  FixedSettlementProvider(this._cacheManager, this._authProvider);
  ...
  Future<void> fetchUserSettlements() async {
    try {
      ...
      if (await _cacheManager.shouldSync()) {
        final response = await SupabaseServiceFix.getUserSettlements();
  ...
  Future<bool> createSettlement(Map<String, dynamic> settlementData) async {
    try {
      ...
      final response =
          await SupabaseServiceFix.createSettlement(settlementData);
  ...
  Future<bool> updateSettlement(
    ...
    try {
      ...
      final response =
          await SupabaseServiceFix.updateSettlement(settlementId, data);
  ...
  Future<bool> deleteSettlement(String settlementId) async {
    try {
      ...
      await SupabaseServiceFix.deleteSettlement(settlementId);
  ...
  Future<bool> markSettlementAsPaid(String settlementId) async {
    try {
      ...
      _error = null;
      notifyListeners();
      final response = await SupabaseServiceFix.updateSettlement(
        settlementId,
